...
requireLogin();
requirePagePermissionFromDB('discipline', 'recompenses/index', 'read', '../../../dashboard.php');
    ...
    <div class="card-body">
        <?php if (empty($recompenses)): ?>
            <div class="text-center py-5">
                ...
                <?php if (!$search && !$type_filter && !$classe_filter && !$date_debut && !$date_fin && hasPagePermissionFromDB('discipline', 'recompenses/add', 'create')): ?>
                    <a href="add.php" class="btn btn-success">
                        <i class="fas fa-plus me-1"></i>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <?php if (hasPagePermissionFromDB('discipline', 'recompenses/view', 'read')): ?>
