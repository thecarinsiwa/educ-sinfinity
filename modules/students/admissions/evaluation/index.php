...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && checkPagePermission('students')) {
    try {
        ...
        showMessage('error', 'Erreur lors de l\'̩valuation : ' . $e->getMessage());
    }
}
...
<!-- Modal d'̩valuation individuelle -->
