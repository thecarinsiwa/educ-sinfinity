...
requirePagePermissionFromDB('students', 'admissions/applications/edit', 'edit', '../../../../dashboard.php');
...
$page_title = 'Modifier Candidature - ' . $candidature['nom_eleve'] . ' ' . $candidature['prenom_eleve'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validation
    if (empty($nom_eleve)) $errors[] = 'Le nom de l\'éléve est obligatoire.';
    if (empty($prenom_eleve)) $errors[] = 'Le prénom de l\'éléve est obligatoire.';
    ...
    if (empty($errors)) {
        try {
            ...
            $sql = "UPDATE demandes_admission SET 
                ...
                certificat_naissance = ?, bulletin_precedent = ?, certificat_medical = ?, photo_identite = ?,
                autres_documents = ?, motif_demande = ?, besoins_speciaux = ?, allergies_medicales = ?,
                observations = ?, updated_at = NOW()
                WHERE id = ?";
            ...
            $errors[] = 'Erreur lors de la modification de la candidature : ' . $e->getMessage();
        }
    }
} else {
    ...
    $_POST = [
        ...
        'profession_pere' => $candidature['profession_pere'],
        'profession_mere' => $candidature['profession_mere'],
        'telephone_parent' => $candidature['telephone_parent'],
        'personne_contact' => $candidature['personne_contact'],
        'telephone_contact' => $candidature['telephone_contact'],
        'relation_contact' => $candidature['relation_contact'],
        'ecole_precedente' => $candidature['ecole_precedente'],
        'classe_precedente' => $candidature['classe_precedente'],
        'annee_precedente' => $candidature['annee_precedente'],
        'moyenne_precedente' => $candidature['moyenne_precedente'],
        'autres_documents' => $candidature['autres_documents'],
        'motif_demande' => $candidature['motif_demande'],
        'besoins_speciaux' => $candidature['besoins_speciaux'],
        'allergies_medicales' => $candidature['allergies_medicales'],
    ...
    if ($candidature['photo_identite']) $_POST['photo_identite'] = '1';
}
...
<form method="POST" class="needs-validation" novalidate>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    <label for="nom_eleve" class="form-label">Nom de l'éléve <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="nom_eleve" name="nom_eleve" 
                           value="<?php echo htmlspecialchars($_POST['nom_eleve'] ?? ''); ?>" required>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="prenom_eleve" class="form-label">Prénom de l'éléve <span class="text-danger">*</span></label>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="telephone" class="form-label">Téléphone de l'éléve</label>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <label for="relation_contact" class="form-label">Relation avec l'éléve</label>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <textarea class="form-control" id="besoins_speciaux" name="besoins_speciaux" rows="3" 
                        placeholder="Décrivez tout besoin spécial de l'éléve..."><?php echo htmlspecialchars($_POST['besoins_speciaux'] ?? ''); ?></textarea>
                </div>
                <div class="col-md-6 mb-3">
