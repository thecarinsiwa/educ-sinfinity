...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validation de l'année prÃ©cÃ©dente
    if (strlen($annee_precedente) > 50) {
        $errors[] = 'L\'année prÃ©cÃ©dente ne peut pas dÃ©passer 50 caractÃ¨res.';
    }
    ...
    if (empty($errors)) {
        try {
            ...
            showMessage('success', "Candidature crÃ©Ã©e avec succÃ¨s. NumÃ©ro : $numero_demande");
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <label for="annee_precedente" class="form-label">AnnÃ©e scolaire prÃ©cÃ©dente</label>
                    <input type="text" class="form-control" id="annee_precedente" name="annee_precedente" 
                           ...
                           title="Format recommandÃ©: AAAA-AAAA (ex: 2023-2024)">
                    <div class="form-text">Format recommandÃ©: AAAA-AAAA</div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 mb-3">
