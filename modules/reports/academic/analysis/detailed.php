<?php
/**
 * Module Rapports Acad̩miques - Analyse d̩taill̩e
    ...
    <div class="alert alert-info">
        ...
        <div class="row">
            <?php if ($periode_filter): ?>
                <div class="col-md-3">
                    <strong>P̩riode :</strong> <?php echo htmlspecialchars($periode_filter); ?>
                </div>
            <?php endif; ?>
            ...
            <?php if ($matiere_filter): ?>
                <div class="col-md-3">
                    <strong>Mati̬re :</strong> <?php echo htmlspecialchars($matieres[array_search($matiere_filter, array_column($matieres, 'id'))]['nom'] ?? ''); ?>
                </div>
            <?php endif; ?>
