<?php
/**
 * Administration - Ajouter un nouveau rôle
...
$page_title = 'Administration - Ajouter un nouveau rôle';
...
<?php if ($success): ?>
    <div class="alert alert-success">
        ...
        <p class="mb-0">Le rôle a été créé avec succès. Vous allez être redirigé vers la liste des rôles.</p>
    </div>
<?php else: ?>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <ul class="list-unstyled small">
                    <li><span class="badge bg-primary me-1">Lire</span> Consulter les données</li>
                    <li><span class="badge bg-success me-1">Créer</span> Ajouter de nouveaux éléments</li>
                    <li><span class="badge bg-warning me-1">Modifier</span> Modifier les données existantes</li>
                    <li><span class="badge bg-danger me-1">Supprimer</span> Supprimer des éléments</li>
                </ul>
                ...
                <ul class="list-unstyled small text-muted">
                    ...
                    <li>• Un rôle actif peut être assigné aux utilisateurs</li>
                    <li>• Les permissions peuvent être modifiées après création</li>
                </ul>
            </div>
        </div>
