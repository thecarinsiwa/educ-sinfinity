 ...
 */
    ...
    class QRimage {
        ...
        //----------------------------------------------------------------------
        public static function png($frame, $back_color = 0xFFFFFF, $fore_color = 0x000000, $filename = false, $pixelPerPoint = 4, $outerFrame = 4, $saveandprint = FALSE)
        {
        ...
        private static function image($frame, $pixelPerPoint = 4, $outerFrame = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000)
        {
            ...
            // S'assurer que w et h sont des entiers
            $w = (int)$w;
            $h = (int)$h;
            
            // S'assurer que les couleurs et outerFrame sont des entiers
            $fore_color = (int)$fore_color;
            $back_color = (int)$back_color;
            $outerFrame = (int)$outerFrame;
